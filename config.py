...
API_ID = int(os.environ.get("API_ID", "24081336"))
API_HASH = os.environ.get("API_HASH", "ca055a6b7f2ed170ddafb8bfdb8a3523")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5712805643:AAGARSzEDf8z1JZvuychqgh5cxY-IZ4okOw")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001612439424")) if os.environ.get("CHANNEL_ID") else []
...
WELCOME_IMAGE = os.environ.get("WELCOME_IMAGE", "https://telegra.ph/file/120a2c3527776e0228190.jpg")
